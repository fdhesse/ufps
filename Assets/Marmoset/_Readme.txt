...
REQUIREMENTS
Marmoset Skyshop requires Unity Free or Pro.
...
UNITY 4 VS. UNITY 5
This build of Skyshop requires Unity 5 (version 5.0 or newer)
For a Unity 4.3.4 compliant build, open the Asset Store window using Unity 4 and import Skyshop again.
...
Thanks also to Joachim Holmer, author of Shader Forge (http://www.neatcorporation.com), for his help with integration.
