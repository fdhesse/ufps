...
public class vp_MPConnection : Photon.MonoBehaviour
{
	...
	protected virtual void OnEnable()
	{
        ...
        vp_GlobalEvent<MultiplayerInfo>.Register("StartMultiplayer", StartMultiplayer);
    }
	...
	protected virtual void OnDisable()
	{
        ...
        vp_GlobalEvent<MultiplayerInfo>.Unregister("StartMultiplayer", StartMultiplayer);
        //vp_GlobalEvent.Unregister("ExitCombat", ExitCombat);
    }

    private void Awake()
    {
        vp_GlobalEvent.Register("ExitCombat", ExitCombat);
    }
	...
	void OnReceivedRoomListUpdate()
	{
        ...
        PhotonNetwork.JoinOrCreateRoom("Room" + matchId, options, TypedLobby.Default);
	}
