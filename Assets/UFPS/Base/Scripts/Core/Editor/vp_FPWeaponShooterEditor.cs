...
public class vp_FPWeaponShooterEditor : Editor
{
	...
	public virtual void DoProjectileFoldout()
	{
		...
		if (m_ProjectileFoldout)
		{
            ...
            m_Component.MaxProjectileSpreadMove = EditorGUILayout.Slider("Max Spread When Moving", m_Component.MaxProjectileSpreadMove, 0, 360);
            m_Component.MaxProjectileSpreadRotate = EditorGUILayout.Slider("Max Spread When Rotate", m_Component.MaxProjectileSpreadRotate, 0, 360);
            m_Component.MaxProjectileSpreadROF = EditorGUILayout.Slider("Max Spread ROF", m_Component.MaxProjectileSpreadROF, 0, 360);
            m_Component.MaxROFAffectTime = EditorGUILayout.Slider("Max ROF affect time", m_Component.MaxROFAffectTime, 0, 8);
