...
public class vp_FPControllerEditor : Editor
{
	...
	public virtual void DoMotorMoveFoldout()
	{
		...
		if (m_MotorMoveFoldout)
		{
		    ...
		    m_Component.MaxPlayerVelocity = EditorGUILayout.Slider("Max player velocity", m_Component.MaxPlayerVelocity, 0, 10);
            m_Component.MaxPlayerRotationAngle = EditorGUILayout.Slider("Max player rotation angle", m_Component.MaxPlayerRotationAngle, 0, 90);
            GUI.enabled = true;
