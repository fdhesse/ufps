...
public static class GUIValuesHelper
{
    /// <summary>
    ...
    // Get rect and control for this float field for identification
        var pos = options == null ? GUILayoutUtility.GetRect (
                new GUIContent (value.ToString ()), 
                GUI.skin.label, 
                GUILayout.ExpandWidth (false), 
                GUILayout.MinWidth (40)) : 
            GUILayoutUtility.GetRect(new GUIContent(value.ToString()), GUI.skin.label, options);
