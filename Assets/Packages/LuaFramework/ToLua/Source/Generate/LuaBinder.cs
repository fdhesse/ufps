...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaContextInterfaceWrap.Register(L);
		MultiplayerInfoWrap.Register(L);
		GameAPIWrap.Register(L);
		ManagerWrap.Register(L);
		BaseWrap.Register(L);
		L.RegFunction("vp_GlobalCallback", vp_GlobalCallback);
	...
	static int vp_GlobalCallback(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(vp_GlobalCallback), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(vp_GlobalCallback), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
