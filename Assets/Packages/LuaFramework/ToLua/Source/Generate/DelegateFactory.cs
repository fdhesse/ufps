...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(vp_GlobalCallback), vp_GlobalCallback);
	}
	...
	class vp_GlobalCallback_Event : LuaDelegate
	{
		public vp_GlobalCallback_Event(LuaFunction func) : base(func) { }
		public vp_GlobalCallback_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate vp_GlobalCallback(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			vp_GlobalCallback fn = delegate() { };
			return fn;
		}

		if(!flag)
		{
			vp_GlobalCallback_Event target = new vp_GlobalCallback_Event(func);
			vp_GlobalCallback d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			vp_GlobalCallback_Event target = new vp_GlobalCallback_Event(func, self);
			vp_GlobalCallback d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
