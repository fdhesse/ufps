...
{
    public static string luaDir = Application.dataPath + "/Packages/LuaFramework/Lua";
    public static string toluaDir = Application.dataPath + "/Packages/LuaFramework/ToLua/Lua";
