...
function Network.Start() 
    ...
    --local buffer = readfile("Proto/ResponseHead");
...
function Network.OnSocket(key, data)
    ...
    --temp solution, for display exception in OnMessage, need to find a way alow expcetion fired by Event.Brocast
