...
public class Packager {
    ...
    [MenuItem("LuaFramework/Build AssetBundles")]
    public static void BuildWindowsResource()
    {
    ...
    public static void BuildAssetResource(BuildTarget target) {
        ...
        //ResourceManager.ClearAssetDatabase();
        ...
        //ResourceManager.HandleExampleBundle();
        //}
        ...
        BundleManager.BuildBundles(target);
        BuildFileIndex();

        string streamDir = Application.dataPath + "/" + AppConst.LuaTempDir;
        if (Directory.Exists(streamDir)) Directory.Delete(streamDir, true);
        string metaFile = Application.dataPath + "/" + "Lua.meta";
    ...
    //        var key = bundleName + fileName;
    //        ResourceManager.AddAsset(key, path);
    //    }
    //}
    ...
    //        ResourceManager.AddBuildMap(name, "*.bytes", path);
    //    }
    //    ResourceManager.AddBuildMap("lua/lua" + AppConst.ExtName, "*.bytes", "Assets/" + AppConst.LuaTempDir);
    ...
    //    AddBuildMap("login" + AppConst.ExtName, "*.prefab", "Assets/IntenseTPS/Prefabs/UI/Login");
    ...
    static void HandleLuaFile() {
        ...
        string[] luaPaths = { AppConst.FrameworkRoot + "/lua/",
                              AppConst.FrameworkRoot + "/Tolua/Lua/" };
