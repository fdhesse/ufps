...
namespace BehaviorDesigner.Runtime.Tasks.Basic.UnityTransform
{
    ...
    public class GetChild : Action
    {
        ...
        [Tooltip("The child as GameObject")]
        [RequiredField]
        public SharedGameObject storeValueAsGameObject;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            storeValueAsGameObject.Value = storeValue.Value.gameObject;
