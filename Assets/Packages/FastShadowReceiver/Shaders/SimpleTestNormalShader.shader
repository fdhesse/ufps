...
Shader "FastShadowReceiver/SimpleTestNormalShader" {
    Properties {  
    ...
    SubShader {  
        ...
        Pass {  
            ...
            vertexOutput vert(vertexInput input) {  
                ...
                output.vertexLighting = float3(0.0, 0, 0);  
...
//              lightDirection = normalize(input.lightDir);  
                ...
                //float3 diffuseReflection = attenuation * max(fixed3(0.2,0.2,0.2), _LightColor0.rgb) * _Color.rgb * max(0.0, dot(normalDirection, lightDirection)) * 2;  
